...
export const DICIONARIO: Traducoes = {
  ...
  // As duas do módulo de fluxos passaram a ser alcançáveis quando a lista
  // ganhou renomear e excluir — antes ninguém conseguia disparar nenhuma das
  // duas pela tela. A de execução viva era um template literal com a contagem;
  // virou frase fixa com o número em `details`, justamente para caber aqui.
  "Já existe um fluxo com esse nome.": { es: "Ya existe un flujo con ese nombre." },
  "Este fluxo tem execuções em andamento. Pause o fluxo e espere terminarem.": {
    es: "Este flujo tiene ejecuciones en curso. Pausa el flujo y espera a que terminen.",
  },
  ...
  "Remover o bloco de início?": { es: "¿Quitar el bloque de inicio?" },
  "Sem um bloco de início o fluxo não pode ser publicado — não há o que o faça começar. O rascunho continua podendo ser salvo, e você pega outro bloco de início na paleta, em Começo.":
    {
      es: "Sin un bloque de inicio el flujo no puede publicarse — no hay nada que lo haga empezar. El borrador se sigue pudiendo guardar, y tomas otro bloque de inicio en la paleta, en Inicio.",
    },
  "O quadro está sem blocos. Ponha ao menos um antes de salvar — o rascunho guardado continua o de antes.":
    {
      es: "El tablero está sin bloques. Pon al menos uno antes de guardar — el borrador guardado sigue siendo el anterior.",
    },
  ...
  "Só o nome muda. As versões publicadas, o histórico e as ligações do quadro continuam como estão.":
    {
      es: "Solo cambia el nombre. Las versiones publicadas, el historial y las uniones del tablero siguen como están.",
    },
  ...
  // ─── Bloco "Horário de funcionamento" do motor de fluxos ───
  "Horário de funcionamento": { es: "Horario de atención" },
  "Separa o que acontece dentro e fora do expediente — e pode segurar o fluxo até abrir.": { es: "Separa lo que pasa dentro y fuera del horario — y puede retener el flujo hasta que abra." },
  "Dentro do horário": { es: "Dentro del horario" },
  "Fora do horário": { es: "Fuera del horario" },
  "Quando estamos abertos": { es: "Cuándo estamos abiertos" },
  "Dias da semana": { es: "Días de la semana" },
  "Das": { es: "Desde" },
  "Escolha ao menos um dia — sem nenhum, o fluxo não publica.": { es: "Elige al menos un día — sin ninguno, el flujo no se publica." },
  "Expediente que atravessa a meia-noite ainda não é suportado — o fim precisa ser depois do começo.": { es: "El horario que cruza la medianoche aún no está soportado — el fin debe ser después del inicio." },
  "O horário é conferido neste fuso, não no do servidor — é o que faz 08:00 significar 08:00 para quem atende.": { es: "El horario se evalúa en esta zona, no en la del servidor — es lo que hace que 08:00 signifique 08:00 para quien atiende." },
  "Quando chegar fora do horário": { es: "Cuando llegue fuera del horario" },
  "O que fazer": { es: "Qué hacer" },
  "Seguir pela saída 'Fora do horário'": { es: "Seguir por la salida 'Fuera del horario'" },
  "Segurar e retomar quando abrir": { es: "Retener y continuar cuando abra" },
  "A execução dorme e continua sozinha na abertura. Ninguém recebe nada de madrugada — nem um aviso de que está fechado.": { es: "La ejecución duerme y continúa sola en la apertura. Nadie recibe nada de madrugada — ni un aviso de que está cerrado." },
  "A execução segue AGORA pela outra saída. É por onde se responde 'atendemos das 8h às 18h' sem deixar a pessoa no vácuo.": { es: "La ejecución sigue AHORA por la otra salida. Es por donde se responde 'atendemos de 8 a 18 h' sin dejar a la persona en el vacío." },
  "domingo": { es: "domingo" },
  "segunda": { es: "lunes" },
  "terça": { es: "martes" },
  "quarta": { es: "miércoles" },
  ...
  "sexta": { es: "viernes" },
  "sábado": { es: "sábado" },
  "Seg a Sex, das {inicio} às {fim}": { es: "Lun a Vie, de {inicio} a {fim}" },
  "Seg a Sex, das {inicio} às {fim} · segura até abrir": { es: "Lun a Vie, de {inicio} a {fim} · retiene hasta abrir" },
  "Todo dia, das {inicio} às {fim}": { es: "Todos los días, de {inicio} a {fim}" },
  "Todo dia, das {inicio} às {fim} · segura até abrir": { es: "Todos los días, de {inicio} a {fim} · retiene hasta abrir" },
  "{n} dias por semana, das {inicio} às {fim}": { es: "{n} días por semana, de {inicio} a {fim}" },
  "{n} dias por semana, das {inicio} às {fim} · segura até abrir": { es: "{n} días por semana, de {inicio} a {fim} · retiene hasta abrir" },

  // ─── Seletor de variáveis dos blocos de fluxo ───
  "Inserir variável": { es: "Insertar variable" },
  "Procurar variável…": { es: "Buscar variable…" },
  "nome_da_variavel": { es: "nombre_de_la_variable" },
  "Usar": { es: "Usar" },
  "Do fluxo": { es: "Del flujo" },
  "Da empresa": { es: "De la empresa" },
  "Do gatilho": { es: "Del disparador" },
  "Deste caminho": { es: "De este camino" },
  "Da execução": { es: "De la ejecución" },
  "A pessoa do outro lado da conversa.": { es: "La persona del otro lado de la conversación." },
  "O card do funil. Vazio quando o fluxo não nasceu de um lead.": { es: "La tarjeta del embudo. Vacía cuando el flujo no nació de un lead." },
  "O dono atual do lead. Vazio enquanto ninguém assumiu.": { es: "El dueño actual del lead. Vacío mientras nadie lo asume." },
  "O que os blocos anteriores gravaram nesta execução.": { es: "Lo que los bloques anteriores guardaron en esta ejecución." },
  "Variáveis da organização, iguais em todo fluxo dela.": { es: "Variables de la organización, iguales en todos sus flujos." },
  "O payload de quem disparou o fluxo — a mensagem, o webhook.": { es: "El payload de quien disparó el flujo — el mensaje, el webhook." },
  "O que é desta frente, e não da execução inteira.": { es: "Lo que es de este frente, y no de la ejecución entera." },
  "A execução em si — útil para depurar, raro numa mensagem.": { es: "La ejecución en sí — útil para depurar, raro en un mensaje." },
  "Id do contato": { es: "Id del contacto" },
  "Situação": { es: "Situación" },
  "Valor (em centavos)": { es: "Valor (en centavos)" },
  "Score de IA": { es: "Score de IA" },
  "Faixa do score": { es: "Franja del score" },
  "Id da etapa": { es: "Id de la etapa" },
  "Id do funil": { es: "Id del embudo" },
  "Id do dono": { es: "Id del dueño" },
  "Id do lead": { es: "Id del lead" },
  "Telefone de aviso": { es: "Teléfono de aviso" },
  "Id da pessoa": { es: "Id de la persona" },
  "Posição no laço (começa em 0)": { es: "Posición en el bucle (empieza en 0)" },
  "Quantos itens o laço tem": { es: "Cuántos ítems tiene el bucle" },
  "Começou em": { es: "Empezó en" },
  "Passos já dados": { es: "Pasos ya dados" },
  "Id da execução": { es: "Id de la ejecución" },
  "O marcador aceita variável: dá para marcar o lead com o que veio no gatilho, em vez de um texto fixo.": { es: "La etiqueta acepta variable: se puede marcar el lead con lo que vino en el disparador, en vez de un texto fijo." },
  "Com DDI. Número fora do formato segue pela saída 'Sem telefone cadastrado'.": { es: "Con código de país. Un número fuera de formato sigue por la salida 'Sin teléfono registrado'." },
