...
const SELECT_COLS = `
  ...
  contacts:contact_id (id, display_name, name, phone_number, is_anonymized, tags, is_blocked, avatar_storage_path, avatar_updated_at, force_human),
  channel_sessions:channel_session_id (id, phone_number, display_name, provider)
`;
